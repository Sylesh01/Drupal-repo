...
(function ($, Drupal) {
    $(document).ready(function(){
        document.getElementById("edit-submit").onclick = function() {myFunction()};

        function myFunction() {
            var x = document.getElementById("edit_name").value;

            if(x>10){
                document.getElementsByClassName('name').innerHTML = "Hello World!";
            }
        }
    })
})(jQuery, Drupal);;
